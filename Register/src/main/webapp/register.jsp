					...
					<div class="card-content">
						...
						<!-- form -->     
							<form action ="Servlet" method ="POST">
								...
								<input type="number" name="user_number" placeholder ="Enter Phone Number">
					
								<input type="text" name="user_address" placeholder ="Enter Address">
								<input type="text" name="user_city" placeholder ="Enter City">
							    <input type="text" name="pincode" placeholder ="Enter Pincode">
								
								<input type="text" name= "user_country" placeholder ="Enter Country">
